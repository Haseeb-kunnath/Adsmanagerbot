...
$disp1 = mysqli_query($db, "SELECT * FROM payout");
       ...
       if($read1[phonepe] == open){
        $insert = mysqli_query($db, "UPDATE payout SET phonepe = 'close' WHERE id = '1'");
        }else{
        $insert = mysqli_query($db, "UPDATE payout SET phonepe = 'open' WHERE id = '1'");
        }
